...
OBJECT_LABELS = {
    ...
    carla.CityObjectLabel.Car: ColorRGBA(r=0.0/255.0, g=0.0/255.0, b=142.0/255.0, a=0.8),
    carla.CityObjectLabel.Motorcycle: ColorRGBA(r=0.0/255.0, g=30.0/255.0, b=142.0/255.0, a=0.8),
    carla.CityObjectLabel.Bicycle: ColorRGBA(r=0.0/255.0, g=100.0/255.0, b=142.0/255.0, a=0.8),
